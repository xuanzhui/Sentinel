...
/**
 * Controller regarding APIs of degrade rules on nacos.
 *
 * @author xuanzhui
 */
@RestController
@RequestMapping("/nacos/degrade")
public class DegradeNacosController {

    private final Logger logger = LoggerFactory.getLogger(DegradeNacosController.class);
    ...
    public Result<List<DegradeRuleEntity>> apiQueryMachineRules(@RequestParam String app) {
        logger.info("query app {} degrade rules", app);
    ...
    public Result<DegradeRuleEntity> apiAddRule(@RequestBody DegradeRuleEntity entity) {
        logger.info("adding new degrade rule: {}", JSON.toJSONString(entity));
    ...
    public Result<DegradeRuleEntity> apiUpdateRule(@PathVariable("id") Long id,
        ...
        logger.info("updating degrade rule, id {}, new rule {}", id, entity);
    ...
    public Result<Long> delete(@PathVariable("id") Long id) {
        logger.info("removing degrade rule, id {}", id);
        if (id == null) {
