 ...
 */
@RestController
@RequestMapping(value = "/nacos/authority")
public class AuthorityRuleNacosController {

    private final Logger logger = LoggerFactory.getLogger(AuthorityRuleNacosController.class);
    ...
    public Result<List<AuthorityRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app) {
        logger.info("query app {} authority rules", app);
    ...
    public Result<AuthorityRuleEntity> apiAddAuthorityRule(@RequestBody AuthorityRuleEntity entity) {
        logger.info("adding new authority rule: {}", JSON.toJSONString(entity));
    ...
    public Result<AuthorityRuleEntity> apiUpdateParamFlowRule(@PathVariable("id") Long id,
        ...
        logger.info("updating authority rule, id {}, new rule {}", id, entity);
    ...
    public Result<Long> apiDeleteRule(@PathVariable("id") Long id) {
        logger.info("removing authority rule, id {}", id);
