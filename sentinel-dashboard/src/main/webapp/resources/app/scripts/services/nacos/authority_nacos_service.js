 ...
 */
angular.module('sentinelDashboardApp').service('AuthorityRuleNacosService', ['$http', function ($http) {
    ...
    this.saveRule = function (entity) {
        return $http({
            url: '/nacos/authority/rule/' + entity.id,
            data: entity,
            method: 'PUT'
        });
    };
