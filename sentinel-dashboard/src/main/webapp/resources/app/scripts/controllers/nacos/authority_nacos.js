 ...
 */
angular.module('sentinelDashboardApp').controller('AuthorityRuleNacosController', ['$scope', '$stateParams', 'AuthorityRuleNacosService', 'ngDialog',
    'MachineService',
    function ($scope, $stateParams, AuthorityRuleNacosService, ngDialog,
              MachineService) {
        ...
        function getMachineRules() {
            ...
            AuthorityRuleNacosService.queryMachineRules($scope.app, mac[0], mac[1])
        ...
        $scope.saveRule = function () {
            if (!AuthorityRuleNacosService.checkRuleValid($scope.currentRule.rule)) {
                return;
            }
        ...
        function addNewRuleAndPush(rule) {
            AuthorityRuleNacosService.addNewRule(rule).success((data) => {
                if (data.success) {
                    getMachineRules();
        ...
        function saveRuleAndPush(rule, edit) {
            AuthorityRuleNacosService.saveRule(rule).success(function (data) {
                if (data.success) {
                    // alert("修改规则成功");
                    getMachineRules();
                    if (edit) {
        ...
        function deleteRuleAndPush(entity) {
            ...
            AuthorityRuleNacosService.deleteRule(entity).success((data) => {
                if (data.code == 0) {
                    getMachineRules();
                    confirmDialog.close();
                } else {
